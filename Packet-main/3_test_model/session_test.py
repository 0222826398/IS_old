...
# Read Dataset    
data_dir = "text_classification-main/model/telnet_session_raw_log/"
output_dir = data_dir
...
###這邊有玉庭式更改
test_text = test_data.Session_payload.values
...
target_name = sorted(list(set(true_labels_array + result_label)))
target_names = list()
...
print("Precision    ", precision_score(test_labels, result_label, average="macro", zero_division = 0))
print("Recall       ", recall_score(test_labels, result_label, average='macro', zero_division = 0))
print("F1           ", f1_score(test_labels, result_label, average="macro", zero_division = 0))
print(true_labels_array)
print(result_label)
# print(classification_report(true_labels_array, result_label, target_names = target_names, zero_division = 0))